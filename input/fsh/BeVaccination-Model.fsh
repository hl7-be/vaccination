...
* protocol 0..0 Reference "The vaccination plan or protocol (not patient-specific) that this vaccination is fulfilling" "The vaccination plan or protocol (not patient-specific) that this vaccination is fulfilling. For example 'Basisvaccinatieschema'"
* type 0..0 code "The type of vaccination action - for example first dose or reinforcement." "The type of vaccination action - for example first dose or reinforcement."
* sequenceNumber 0..0 string "The sequence number of an immunization - whether it is the first dose, or second dose..." "The sequence number of an immunization when part of a protocol - if it is the first dose, or second dose..."
* reliability 0..0 CodeableConcept "The reliability of the registration (regarding performer, vaccine, date of administration)"
...
* administeredProduct.lotNumber -> "extension.be-ext-administeredProduct.batch.lotNumber lotNumber vaccination?"
* administeredProduct.expirationDate -> "extension.be-ext-administeredProduct.batch.expirationDate expirationDate vaccination?"
* route -> "route"
* status -> "status"
