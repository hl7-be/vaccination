Instance: recorder-logical-reference
InstanceOf: BeVaccination 
Usage: #example 
Description: "Use of a logical reference in the recorder extension"
Title:   "Use of a logical reference in the recorder extension"
