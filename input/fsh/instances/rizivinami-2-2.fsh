Instance: rizivinami-2-2
InstanceOf: BeVaccination
* contained[+] = rizivinami-e-2-2
* contained[+] = rizivinami-l-2-2
* recorded = "2023-08-07"
...
* extension[recorder].valueReference.identifier.value = "45814781"
...
* encounter = Reference(rizivinami-e-2-2)
* site = $sct#102291007
...
Instance: rizivinami-e-2-2
InstanceOf: Encounter
Usage: #inline
* subject.identifier.system = "https://www.ehealth.fgov.be/standards/fhir/core/NamingSystem/ssin"
* subject.identifier.value = "20020142173"
* location[+].location = Reference(rizivinami-l-2-2)
* status = #finished
* class = http://terminology.hl7.org/CodeSystem/v3-ActCode#AMB

Instance: rizivinami-l-2-2
InstanceOf: Location
Usage: #inline
* type = https://www.ehealth.fgov.be/standards/fhir/vaccination/CodeSystem/be-cs-care-location#nursing-home