Instance: rizivinami-8-2
InstanceOf: BeVaccination
* contained[+] = rizivinami-e-8-2
* contained[+] = rizivinami-l-8-2
* recorded = "2023-08-07"
...
* status = #not-done
* encounter = Reference(rizivinami-e-8-2)

Instance: rizivinami-e-8-2
InstanceOf: Encounter
Usage: #inline
* subject.identifier.system = "https://www.ehealth.fgov.be/standards/fhir/core/NamingSystem/ssin"
* subject.identifier.value = "20020142173"
* location[+].location = Reference(rizivinami-l-8-2)
* status = #finished
* class = http://terminology.hl7.org/CodeSystem/v3-ActCode#AMB

Instance: rizivinami-l-8-2
InstanceOf: Location
Usage: #inline
